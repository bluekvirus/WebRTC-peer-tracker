...
(function() {
    ...
    window.RTCMultiConnection = function(channel) {
        ...
        connection.bandwidth = {
            screen: 512 // 512kbps (dirty workaround)
        };
    ...
    function SignalingHandler(connection, callbackForSignalingReady) {
        ...
        function handlePeersNegotiation(_config) {
            ...
            function updateSocket() {
                ...
                connection.onPeersChanged && connection.onPeersChanged();
            }
        ...
        connection.remove = function(userid) {
            ...
            this.onPeersChanged && this.onPeersChanged();
        };
        ...
        return {
            ...
            setRemoteDescription: function(sessionDescription, onSdpSuccess) {
                ...
                this.connection.setRemoteDescription(
                    ...
                    function(error) {
                        if (error.search && error.search(/STATE_SENTINITIATE|STATE_INPROGRESS/gi) === -1) {
